...
CREATE TABLE `student_course_time_table`
(
    `id`                  int(11)     NOT NULL AUTO_INCREMENT,
    `student_id`          int(11)     NOT NULL COMMENT '学生编号',
    `course_timetable_id` int(11)     NOT NULL COMMENT '课表id',
    `term_year`           varchar(20) NOT NULL COMMENT '学年',
    `term_order`          int(11)     NOT NULL COMMENT '学期',
    PRIMARY KEY (`id`),
